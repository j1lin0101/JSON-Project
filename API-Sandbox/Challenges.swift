...
internal func exerciseOne() {
    ...
    print("\(firstName) \(lastName) lives at \(street) in \(city), \(state), \(postCode). If you want to contact \(title) \(lastName), you can email \(emailAddress) or call at \(cellNumber)")
